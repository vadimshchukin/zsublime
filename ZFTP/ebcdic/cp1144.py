""" Python Character Mapping Codec cp1144 generated from 'temp/cp1144.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\\'        #  0x48 -> REVERSE SOLIDUS
    '\xf1'      #  0x49 -> LATIN SMALL LETTER N WITH TILDE
    '\xb0'      #  0x4A -> DEGREE SIGN
    '.'         #  0x4B -> FULL STOP
    '<'         #  0x4C -> LESS-THAN SIGN
    ...
    '\xe9'      #  0x5A -> LATIN SMALL LETTER E WITH ACUTE
    '$'         #  0x5B -> DOLLAR SIGN
    '*'         #  0x5C -> ASTERISK
    ...
    '\xf2'      #  0x6A -> LATIN SMALL LETTER O WITH GRAVE
    ','         #  0x6B -> COMMA
    '%'         #  0x6C -> PERCENT SIGN
    '_'         #  0x6D -> LOW LINE
    ...
    '\xf9'      #  0x79 -> LATIN SMALL LETTER U WITH GRAVE
    ':'         #  0x7A -> COLON
    '\xa3'      #  0x7B -> POUND SIGN
    ...
    '\u20ac'    #  0x9F -> EURO SIGN
    '\xb5'      #  0xA0 -> MICRO SIGN
    '\xec'      #  0xA1 -> LATIN SMALL LETTER I WITH GRAVE
    ...
    '\xe0'      #  0xC0 -> LATIN SMALL LETTER A WITH GRAVE
    ...
    '\xe8'      #  0xD0 -> LATIN SMALL LETTER E WITH GRAVE
    ...
    '\xe7'      #  0xE0 -> LATIN SMALL LETTER C WITH CEDILLA
