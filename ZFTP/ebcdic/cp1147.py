""" Python Character Mapping Codec cp1147 generated from 'temp/cp1147.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\xf9'      #  0x6A -> LATIN SMALL LETTER U WITH GRAVE
    ','         #  0x6B -> COMMA
    '%'         #  0x6C -> PERCENT SIGN
    '_'         #  0x6D -> LOW LINE
    ...
    ':'         #  0x7A -> COLON
    '\xa3'      #  0x7B -> POUND SIGN
    '\xe0'      #  0x7C -> LATIN SMALL LETTER A WITH GRAVE
    "'"         #  0x7D -> APOSTROPHE
    '='         #  0x7E -> EQUALS SIGN
    '"'         #  0x7F -> QUOTATION MARK
    ...
    '\xe9'      #  0xC0 -> LATIN SMALL LETTER E WITH ACUTE
