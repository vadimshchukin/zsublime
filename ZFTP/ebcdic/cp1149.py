""" Python Character Mapping Codec cp1149 generated from 'temp/cp1149.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\xde'      #  0x4A -> LATIN CAPITAL LETTER THORN
    '.'         #  0x4B -> FULL STOP
    '<'         #  0x4C -> LESS-THAN SIGN
    ...
    '\xc6'      #  0x5A -> LATIN CAPITAL LETTER AE
    '$'         #  0x5B -> DOLLAR SIGN
    '*'         #  0x5C -> ASTERISK
    ')'         #  0x5D -> RIGHT PARENTHESIS
    ';'         #  0x5E -> SEMICOLON
    '\xd6'      #  0x5F -> LATIN CAPITAL LETTER O WITH DIAERESIS
    '-'         #  0x60 -> HYPHEN-MINUS
    '/'         #  0x61 -> SOLIDUS
    ...
    '\xf0'      #  0x79 -> LATIN SMALL LETTER ETH
    ':'         #  0x7A -> COLON
    '#'         #  0x7B -> NUMBER SIGN
    '\xd0'      #  0x7C -> LATIN CAPITAL LETTER ETH
    "'"         #  0x7D -> APOSTROPHE
    '='         #  0x7E -> EQUALS SIGN
    '"'         #  0x7F -> QUOTATION MARK
    ...
    '}'         #  0x9C -> RIGHT CURLY BRACKET
    '\xb8'      #  0x9D -> CEDILLA
    ']'         #  0x9E -> RIGHT SQUARE BRACKET
    '\u20ac'    #  0x9F -> EURO SIGN
    '\xb5'      #  0xA0 -> MICRO SIGN
    ...
    '\xaf'      #  0xBC -> MACRON
    '\xa8'      #  0xBD -> DIAERESIS
    '\\'        #  0xBE -> REVERSE SOLIDUS
    '\xd7'      #  0xBF -> MULTIPLICATION SIGN
    '\xfe'      #  0xC0 -> LATIN SMALL LETTER THORN
    ...
    '\xe6'      #  0xD0 -> LATIN SMALL LETTER AE
