""" Python Character Mapping Codec cp1047 generated from 'temp/cp1047.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\xdd'      #  0xBA -> LATIN CAPITAL LETTER Y WITH ACUTE
    '\xa8'      #  0xBB -> DIAERESIS
    '\xaf'      #  0xBC -> MACRON
    ']'         #  0xBD -> RIGHT SQUARE BRACKET
