""" Python Character Mapping Codec cp278 generated from 'temp/cp278.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\x80'      #  0x20 -> LATIN 1 SUPPLEMENT 80
    '\x81'      #  0x21 -> LATIN 1 SUPPLEMENT 81
    ...
    '\x99'      #  0x39 -> LATIN 1 SUPPLEMENT 99
    ...
    '\xa4'      #  0x5A -> CURRENCY SIGN
    '\xc5'      #  0x5B -> LATIN CAPITAL LETTER A WITH RING ABOVE
    '*'         #  0x5C -> ASTERISK
    ...
    '\xe9'      #  0x79 -> LATIN SMALL LETTER E WITH ACUTE
    ':'         #  0x7A -> COLON
    '\xc4'      #  0x7B -> LATIN CAPITAL LETTER A WITH DIAERESIS
    '\xd6'      #  0x7C -> LATIN CAPITAL LETTER O WITH DIAERESIS
    "'"         #  0x7D -> APOSTROPHE
    '='         #  0x7E -> EQUALS SIGN
    '"'         #  0x7F -> QUOTATION MARK
    ...
    ']'         #  0x9F -> RIGHT SQUARE BRACKET
    '\xb5'      #  0xA0 -> MICRO SIGN
    '\xfc'      #  0xA1 -> LATIN SMALL LETTER U WITH DIAERESIS
    ...
    '\xe5'      #  0xD0 -> LATIN SMALL LETTER A WITH RING ABOVE
    ...
    '\xc9'      #  0xE0 -> LATIN CAPITAL LETTER E WITH ACUTE
