""" Python Character Mapping Codec cp277 generated from 'temp/cp277.txt' with gencodec.py.
...
decoding_table = (
    ...
    '\xf8'      #  0x6A -> LATIN SMALL LETTER O WITH STROKE
    ','         #  0x6B -> COMMA
    '%'         #  0x6C -> PERCENT SIGN
    '_'         #  0x6D -> LOW LINE
    ...
    '`'         #  0x79 -> GRAVE ACCENT
    ':'         #  0x7A -> COLON
    '\xc6'      #  0x7B -> LATIN CAPITAL LETTER AE
    '\xd8'      #  0x7C -> LATIN CAPITAL LETTER O WITH STROKE
    "'"         #  0x7D -> APOSTROPHE
    '='         #  0x7E -> EQUALS SIGN
    '"'         #  0x7F -> QUOTATION MARK
    '@'         #  0x80 -> COMMERCIAL AT
    ...
    '{'         #  0x9C -> LEFT CURLY BRACKET
    '\xb8'      #  0x9D -> CEDILLA
    '['         #  0x9E -> LEFT SQUARE BRACKET
    ...
    '\xe6'      #  0xC0 -> LATIN SMALL LETTER AE
