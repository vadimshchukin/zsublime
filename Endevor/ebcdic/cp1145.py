""" Python Character Mapping Codec cp1145 generated from 'temp/cp1145.txt' with gencodec.py.
...
decoding_table = (
    ...
    '#'         #  0x69 -> NUMBER SIGN
    '\xf1'      #  0x6A -> LATIN SMALL LETTER N WITH TILDE
    ','         #  0x6B -> COMMA
    '%'         #  0x6C -> PERCENT SIGN
    '_'         #  0x6D -> LOW LINE
    ...
    '`'         #  0x79 -> GRAVE ACCENT
    ':'         #  0x7A -> COLON
    '\xd1'      #  0x7B -> LATIN CAPITAL LETTER N WITH TILDE
    '@'         #  0x7C -> COMMERCIAL AT
    "'"         #  0x7D -> APOSTROPHE
    '='         #  0x7E -> EQUALS SIGN
    '"'         #  0x7F -> QUOTATION MARK
    ...
    '^'         #  0xBA -> CIRCUMFLEX ACCENT
    '!'         #  0xBB -> EXCLAMATION MARK
    '\xaf'      #  0xBC -> MACRON
    '~'         #  0xBD -> TILDE
